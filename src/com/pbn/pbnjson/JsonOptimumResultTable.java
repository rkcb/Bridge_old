...
public class JsonOptimumResultTable extends JsonTable {
	...
	private static int decli = -1; // undefined index
	private static int denomi = -1; // undefined index
	...
	/***
	 * createRowComparator creates a comparator for the rows; this ordering
	 * is independent of the column order
	 *
	 * @param decli
