...
public class NewUserCompetionsView extends EVerticalLayout implements View {

    public static final String name = "/new/user/competions";
    ...
    public NewUserCompetionsView(MainMenu menu) {
