...
public class NewUploadView /* extends EVerticalLayout implements View */ {
    //
    // public static final String name = "/new/admin/upload";
    //
    ...
    //
    // public NewUploadView(MainMenu mainMenu) {
    ...
    //
    // /***
    // * getCurrentTotalResultsFile returns the first found total results file
    // in
    ...
    //
    // /***
    // * updatePlayerParticipations checks which players played in the
    // tournament
    ...
    //
    // /***
    // * addParticipation adds the tour to player entities that were found by
    // fed
