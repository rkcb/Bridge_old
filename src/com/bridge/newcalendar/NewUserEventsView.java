...
public class NewUserEventsView extends EVerticalLayout implements View {
    public static final String name = "new/user/events";
    ...
    public NewUserEventsView(MainMenu mainMenu) {
