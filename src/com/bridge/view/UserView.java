...
/***
 * this class is typically visible to the user and the administrators only -- it
 * used to edit user related data
 */
...
public class UserView extends VerticalLayout implements View {
    ...
    private JPAContainer<User> us = JPAContainerFactory.make(User.class,
            "BridgeResults");
    private JPAContainer<Player> ps = JPAContainerFactory.make(Player.class,
            "BridgeResults");
    @SuppressWarnings("unused")
    private JPAContainer<UILanguage> langs = JPAContainerFactory
            .make(UILanguage.class, "BridgeResults");
